...
public class WavUtility
{
	...
	public static byte[] FromAudioClip(AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirname = "recordings", string ActualPath = "")
	{
		...
		int fileSize = ((audioClip.samples * audioClip.channels) * 2) + headerSize;
